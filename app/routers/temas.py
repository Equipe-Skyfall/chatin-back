...
from app.deps import AdminUserId, AiProviderDep, CurrentUserId, MateriaRepo, ProgressoRepo, TemaRepo
...
def deletar_tema(
    materia_id: UUID, tema_id: UUID, _admin_id: AdminUserId, tema_repo: TemaRepo
) -> None:
...
def obter_tema(
    tema_id: UUID, user_id: CurrentUserId, tema_repo: TemaRepo, progresso_repo: ProgressoRepo
) -> TemaDetailOut:
